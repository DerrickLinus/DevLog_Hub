...
export default async function TagArticlesPage(props: { params: Promise<{ name: string }> }) {
		...
		<div className="bg-white min-h-screen">
			<div className="max-w-5xl mx-auto px-6 py-12">
				<header className="mb-8 flex items-center justify-between">
					...
					<Link href="/tags" className="text-sm text-blue-600 hover:text-blue-800 transition-colors">← 返回 Tags</Link>
				</header>
